...
CAPTIONS = [
    ...
    "Это и есть ваш Астрокот?",
    "А вот это уголовка",
    "Это база",
    "В этом виноваты капиталисты",
    "Ему больше не наливать",
    "Признан иноагентом\nна территории РФ",
    "Покорми меня",
    "Было бы у меня такое,\nя бы и не женился никогда",
    "Бывший ССовец",
    "В Испании это\nиспользовалось как пытка",
    "Земля стекловатой",
    "Спасибо за счастливое детство",
    "Он явно что-то знает",
    "Не канон",
    "Типичный день в офисе Астрокота",

    "Дьявол во плоти",
    "Ангел во плоти",
    "Мечта каждого подростка",
    "И на это было выделено\n5 000 000 рублей из бюджета...",
    "Вот чем вдохновлялся Миядзаки",
    "Если бы это было у Сталина\nВОВ закончилась бы за 2 дня",
    "Не показывайте это Астро",
    "Следующий проект Астро",
    "Оно хочет кушать...",
    "Пускайте в серийное производство",
    "Подарите это Астро на день рождения",
    "Если ваша вечеринка не похожа\nна это, даже не зовите меня",
    "Рай на земле",
    "Почему развалился СССР:",
    "Почему Германия проиграла в ВМВ:",
    "Почему пала Римская империя:",
    "Прожили бы здесь 3 месяца без\nинтернета за миллион рублей?",
    "Лучшее место для первого свидания",
    '"Как бы ты хотел отметить ДР?"\nЯ:',
    "Личные войска Астро",
    "В СССР такое делали школьники на уроках труда",
    "Вас закрыли с ним в комнате на сутки. Ваши действия?",
    "О чём мечтает Астро:",
    "Здесь живёт разработчик КСД",
    "Ставь лайк, если хочешь так же",
    "Лучший подарок",
    "Израиль, берегись",
    "Трепещи, Америка",
    "При коммунизме такое будет у каждого",
    "Сюда бы парочку авиабомб…",
]